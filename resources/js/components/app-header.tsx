...
import { CalendarDays, CheckSquare, LayoutGrid, Menu, Users } from 'lucide-react';
...
const activeItemStyles = 'text-primary dark:bg-sidebar-accent dark:text-sidebar-accent-foreground';
